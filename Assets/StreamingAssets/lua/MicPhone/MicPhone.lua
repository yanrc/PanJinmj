...
function MicPhone.OnCreate(obj)
	InputObj = obj.transform:Find('Micphone/MicBg').gameObject
	Slider = obj.transform:Find('Micphone/MicBg/FillWrite'):GetComponent('Slider')
	micArray = Microphone.devices;
	audio = obj.transform:Find('Micphone'):GetComponent('AudioSource')
end
