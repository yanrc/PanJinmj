...
function PlayRecordPanel.OnCreate(obj)
	...
	dirObj[1] = transform:Find('table/Down/Red1').gameObject
	dirObj[2] = transform:Find('table/Right/Red2').gameObject
	dirObj[3] = transform:Find('table/Up/Red3').gameObject
	dirObj[4] = transform:Find('table/Left/Red4').gameObject
	imgDuanMen = transform:Find('imgDuanMen'):GetComponent('Image')
	LeftCard = transform:Find('table/LeftCard/Text'):GetComponent('Text')
	LeftRound = transform:Find('table/LeftRound/Text'):GetComponent('Text')
	roomRemark = transform:Find('RoomText'):GetComponent('Text')
	processText = transform:Find('process/Text'):GetComponent('Text')
	for i = 1, 4 do
		parentList[i] = transform:Find('HandCardParent/parent' .. i)
		outparentList[i] = transform:Find('throwCardParent/parent' .. i)
		cpgParent[i] = transform:Find('pengGangParent/parent' .. i)
		playerItems[i] = RecordPlayerItem.New(transform:Find('playList/Player' .. i).gameObject)
	end
	LiujuEffect = transform:Find('LiujuEffect').gameObject
	btnPlay = transform:Find('playCtrlPanel/btnPlay').gameObject
	btnStop = transform:Find('playCtrlPanel/btnStop').gameObject
	btnForward = transform:Find('playCtrlPanel/btnForward').gameObject
	btnBackward = transform:Find('playCtrlPanel/btnBackward').gameObject
	btnExit = transform:Find('playCtrlPanel/btnExit').gameObject
