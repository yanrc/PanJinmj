...
function SettingPanel.OnCreate(obj)
	...
	this:Init(obj)
	jiesanBtn = transform:Find('Button').gameObject
	jiesanBtnStr = transform:Find('Button/Text'):GetComponent('Text')
	btnClose = transform:Find('Image_Enter_Room_Bg/Button_Close').gameObject
	btnMinYinYue = transform:Find('Slider_yinyue/Image (1)').gameObject
	btnMaxYinYue = transform:Find('Slider_yinyue/Image (2)').gameObject
	btnMinYinXiao = transform:Find('Slider_yinxiao/Image (1)').gameObject
	btnMaxYinXiao = transform:Find('Slider_yinxiao/Image (2)').gameObject
	sliderYinYue = transform:Find('Slider_yinyue'):GetComponent('Slider')
	sliderYinXiao = transform:Find('Slider_yinxiao'):GetComponent('Slider')
