...
function SharePanel.OnCreate(obj)
	...
	this:Init(obj)
	btnClose = transform:FindChild('root/btnClose').gameObject
	btnWeChat = transform:FindChild('root/btnWeChat').gameObject
	btnWeChatMoments = transform:FindChild('root/btnWeChatMoments').gameObject
