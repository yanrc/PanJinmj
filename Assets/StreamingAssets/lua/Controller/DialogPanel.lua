...
function DialogPanel.OnCreate(obj)
	...
	this:Init(obj)
	texttitle = transform:Find('Text2'):GetComponent('Text')
	textmsg = transform:Find('Text_Msg'):GetComponent('Text')
	btnConfirm = transform:Find('Button_OK').gameObject
	btnCancel = transform:Find('Button_Cancle').gameObject
end
