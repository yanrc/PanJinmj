...
function HomePanel.OnCreate(go)
	...
	this:Init(go)
	nickNameText = go.transform:Find("Panel_Left/Text_Nick_Name"):GetComponent("Text")
	cardCountText = go.transform:Find("Panel_Left/Image_Card_Number_Bg/Text"):GetComponent("Text")
	IpText = go.transform:Find("Panel_Left/Text_Nick_IP"):GetComponent("Text")
	headIconImg = go.transform:Find("Panel_Left/Image_icon"):GetComponent("Image")
	headIconbg = go.transform:Find("Panel_Left/Image_icon_bg").gameObject
	contactInfoContent = go.transform:Find("roomCardInfo/Text_Info_Content"):GetComponent("Text")
	roomCardPanel = go.transform:Find("roomCardInfo").gameObject
	noticeText = go.transform:Find("Image_Notice_BG/Image (1)/Text"):GetComponent("Text")
	CreateRoomButton = go.transform:Find("Panel_Room/Button_Create_Room").gameObject
	EnterRoomButton = go.transform:Find("Panel_Room/Button_Enter_Room").gameObject
	btnMessage = go.transform:Find("Panel_Right/btnMessage").gameObject
	btnRule = go.transform:Find("Panel_Right/btnRule").gameObject
	btnSet = go.transform:Find("Panel_Right/btnSet").gameObject
	btnBuy = go.transform:Find("Panel_Left/Image_Card_Number_Bg/jiahao").gameObject
	btnShop = transform:Find("Bottom/shop").gameObject
	btnShare = transform:Find("Bottom/share").gameObject
	btnRecord = transform:Find("Bottom/Record").gameObject
	logo=transform:Find("Image_Bg/logo"):GetComponent("Image")
