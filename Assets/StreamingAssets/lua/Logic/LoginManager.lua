...
function LoginManager.TestLoginClick()
	...
	loginvo.sex = 1;
	loginvo.IP = GlobalData.Instance().getIpAddress();
	local data = json.encode(loginvo);
	GlobalData.Instance().loginVo = loginvo;
	GlobalData.Instance().loginResponseData = AvatarVO.New();
	GlobalData.Instance().loginResponseData.account =Account.New();
	GlobalData.Instance().loginResponseData.account.city = loginvo.city;
	GlobalData.Instance().loginResponseData.account.openid = loginvo.openId;
	GlobalData.Instance().loginResponseData.account.nickname = loginvo.nickName;
	GlobalData.Instance().loginResponseData.account.headicon = loginvo.headIcon;
	GlobalData.Instance().loginResponseData.account.unionid = loginvo.city;
	GlobalData.Instance().loginResponseData.account.sex = loginvo.sex;
	GlobalData.Instance().loginResponseData.IP = loginvo.IP;
