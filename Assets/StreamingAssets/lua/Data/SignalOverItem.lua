...
function SignalOverItem.New(obj)
	...
	-- 名字
	this.nickName = obj.transform:Find("Text_Palyer_Name"):GetComponent("Text")
	-- 描述
	this.resultDes = obj.transform:Find("Text_Game_Result_Describe"):GetComponent("Text")
	-- 胡牌图标
	this.huFlagImg = obj.transform:Find("Image_Hu_Label"):GetComponent("Image")
	-- 番数
	this.fanCount = obj.transform:Find("Scores/Text/Text_Fanshu"):GetComponent("Text")
	-- 杠分
	this.gangScore = obj.transform:Find("Scores/Text1/Text_Gangfen"):GetComponent("Text")
	-- 总分
	this.totalScroe = obj.transform:Find("Scores/Text2/Text_Total_Score"):GetComponent("Text")
	-- 牌面板
	this.paiArrayPanel = obj.transform:Find("Panel_Pai_Array")
	-- 中码图片
	this.zhongMaFlag = obj.transform:Find("Image_zhongma_flag"):GetComponent("Image")
	-- 跟庄图片
	this.GenzhuangFlag = obj.transform:Find("Image_gen_zhuang"):GetComponent("Image")
	-- 庄家图片
	this.Banker = obj.transform:Find("Text_Palyer_Name/Image_banker"):GetComponent("Image")
	-- 加钢文字
	this.JiaGang = obj.transform:Find("Text_Palyer_Name/jiagang"):GetComponent("Image")
	this.gangPaiList = { }
	this.pengPaiList = { }
	this.chiPaiList = { }
